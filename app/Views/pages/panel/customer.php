...
<div class="page-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-wrapper">
                        <table class="striped highlight responsive-table" id="table-customer" width="100%">
                            <thead>
                            </thead>
                            <tbody>
                            </tbody>
    ...
    <div class="page slider" data-page="form">
        ...
        <div class="container">
            <div class="row">
                <form class="col s12 m6 offset-m3 form" id="form-customer" action="" method="POST">
                    <h1 class="form-title">Tambah Data Pelanggan</h1>
                    <div class="row">
...
<div class="popup side" data-page="edit">
    ...
    <form action="" id="form-edit" class="row">
        ...
        <div class="input-field col s12">
            <textarea id="edit-address" name="address" class="materialize-textarea"></textarea>
            <label for="edit-address">Alamat (Opsional)</label>
        </div>
        <div class="row">
            <div class="input-field col s12 center">
                <button class="btn waves-effect waves-light green" type="submit"><i
